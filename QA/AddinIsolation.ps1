        ...
        foreach ($file in $files) {
            ...
            try {
                ...
                elseif ($scope -eq 'UserProfile') {
                    ...
                    if ($file.Name -in @('Repato.CreateLevels.TestRunner.addin','Repato.TestRunner.addin','Repato.GridBubbleVisibility.TestRunner.addin','Repato.GridBubbleOffset.TestRunner.addin','Repato.GridResequence.TestRunner.addin')) {
