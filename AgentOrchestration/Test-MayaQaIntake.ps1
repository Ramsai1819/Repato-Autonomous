...
$expected = if ($id -eq 'create-levels') { 'create-levels-elevations-v1' } elseif ($id -eq 'welcome-smoke') { 'welcome-supervised-dialog-v1' } elseif ($id -eq 'grid-resequence-v1') { 'grid-resequence-all-directions-v1' } else { $id }
