...
$failed=$false;try{Invoke-MayaQaRequest -StoreRoot ([IO.Path]::GetTempPath()) -UserRequest 'Do unsupported QA' -DryRun|Out-Null}catch{$failed=$_.Exception.Message -match 'Unsupported QA request'}
