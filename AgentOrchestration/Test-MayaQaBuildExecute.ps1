...
$unsupported = $false; try { Invoke-MayaQaBuildExecute $root taskx workflowx create-plan-views -DryRun | Out-Null } catch { $unsupported = $true }; if (-not $unsupported) { throw 'Unsupported workflow accepted.' }
